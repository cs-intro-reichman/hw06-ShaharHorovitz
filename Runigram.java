...
public class Runigram {
	...
	public static Color[][] blend(Color[][] image1, Color[][] image2, double alpha) {
		Color[][] blended_image = new Color[image1.length][image1[0].length]; //creates a new image
		for (int i = 0; i<blended_image.length; i++)
		{
			for (int j = 0; j<blended_image[i].length; j++)
			{
